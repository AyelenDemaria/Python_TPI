...
SECRET_KEY = 'django-insecure-b0xyo-!f3^+c0_$-)gen7rz6(ey)=zvqdk^+y)*75c0o6c3(q7'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'soporte_tpi', #Si no existe crearla desde mysql workbench
        'USER': 'root',
        'PASSWORD':'root',
        'HOST'     : 'localhost',
    }
...
#LOGIN_REDIRECT_URL = 'instalaciones/'
